package com.stringee.softphone.view;
...
public class CircleImageView extends ImageView {
    ...
    // public void drawGradient(int startColor, int midColor, int endColor) {
    ...
    // Bitmap bitmap = Bitmap.createBitmap(50, 50, BITMAP_CONFIG);
    // Canvas canvas = new Canvas(bitmap);
    // drawable.setBounds(0, 0, canvas.getWidth(), canvas.getHeight());
    // drawable.draw(canvas);
