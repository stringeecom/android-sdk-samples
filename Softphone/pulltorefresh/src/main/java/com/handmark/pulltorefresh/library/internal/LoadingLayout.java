...
public abstract class LoadingLayout extends FrameLayout implements
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case PULL_FROM_END:
			...
			// Load in labels
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrPullTextBottom)) {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrPullTextBottom);
			} else {
				mPullLabel = context
			...
			if (attrs
					.hasValue(R.styleable.PullToRefresh_ptrRefreshingTextBottom)) {
				mRefreshingLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrRefreshingTextBottom);
			} else {
				mRefreshingLabel = context
						.getString(R.string.pull_to_refresh_from_bottom_refreshing_label);
			}
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrReleaseTextBottom)) {
				mReleaseLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrReleaseTextBottom);
			} else {
		...
		default:
			...
			// Load in labels
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrPullText)) {
				mPullLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrPullText);
			} else {
				mPullLabel = context
						.getString(R.string.pull_to_refresh_pull_label);
			}

			if (attrs.hasValue(R.styleable.PullToRefresh_ptrRefreshingText)) {
				mRefreshingLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrRefreshingText);
			} else {
				mRefreshingLabel = context
						.getString(R.string.pull_to_refresh_refreshing_label);
			}
			if (attrs.hasValue(R.styleable.PullToRefresh_ptrReleaseText)) {
				mReleaseLabel = attrs
						.getString(R.styleable.PullToRefresh_ptrReleaseText);
			} else {
				mReleaseLabel = context
