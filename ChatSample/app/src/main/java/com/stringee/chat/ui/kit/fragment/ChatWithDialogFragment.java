...
public class ChatWithDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new Builder(activity).setTitle(R.string.chat_with_user).setPositiveButton(R.string.start, (dialogInterface, pos) -> {
            ...
            if (editTextValue.trim().equals(Common.client.getUserId())) {
            ...
            User user = new User(editTextValue.trim());
