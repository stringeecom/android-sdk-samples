...
public class CusKeyboardWidget extends ViewGroup {
    ...
    private static final int VELOCITY_UNITS = 2000;
    ...
    // /
    private String mOpenCode = "RESULT_CODE_DEFAULT";
    ...
    public static interface OnDrawerCloseListener {
         ...
         */
        public void onCusKeyboardClosed();
    }
    ...
    public static interface OnDrawerScrollListener {
         ...
         */
        public void onCusKeyboardScrollEnded();
    }
     ...
     */
    public CusKeyboardWidget(Context context, AttributeSet attrs) {
     ...
     */
    public CusKeyboardWidget(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Stringee_Keyboard, defStyle, 0);

        int orientation = a.getInt(R.styleable.Stringee_Keyboard_stringee_direction, ORIENTATION_BTT);
        mVertical = (orientation == ORIENTATION_BTT || orientation == ORIENTATION_TTB);
        mBottomOffset = (int) a.getDimension(R.styleable.Stringee_Keyboard_stringee_bottomOffset, 0.0f);
        mTopOffset = (int) a.getDimension(R.styleable.Stringee_Keyboard_stringee_topOffset, 0.0f);
        mAllowSingleTap = a.getBoolean(R.styleable.Stringee_Keyboard_stringee_allowSingleTap, true);
        mAnimateOnClick = a.getBoolean(R.styleable.Stringee_Keyboard_stringee_animateOnClick, true);
        mInvert = (orientation == ORIENTATION_TTB || orientation == ORIENTATION_LTR);

        int handleId = a.getResourceId(R.styleable.Stringee_Keyboard_stringee_handle, 0);
        if (handleId == 0) {
            throw new IllegalArgumentException("The handle attribute is required and must refer " + "to a valid child.");
        }

        int contentId = a.getResourceId(R.styleable.Stringee_Keyboard_stringee_content, 0);
        if (contentId == 0) {
    ...
    protected View getViewChild(int idView) {
        return findViewById(mHandleId);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mOnDrawerScrollListener != null) {
                mOnDrawerScrollListener.onCusKeyboardScrollStarted();
            }
    ...
    private void stopTracking() {
        ...
        if (mOnDrawerScrollListener != null) {
            mOnDrawerScrollListener.onCusKeyboardScrollEnded();
        }
    ...
    public void animateClose() {
        ...
        if (scrollListener != null) {
            scrollListener.onCusKeyboardScrollStarted();
        }
        animateClose(mVertical ? mHandle.getTop() : mHandle.getLeft());

        if (scrollListener != null) {
            scrollListener.onCusKeyboardScrollEnded();
        }
    }
    ...
    public void animateOpen(String openCode) {
        this.mOpenCode = openCode;
        animateOpen();
    }
    ...
    private void closeDrawer() {
        ...
        if (mOnDrawerCloseListener != null) {
            mOnDrawerCloseListener.onCusKeyboardClosed();
        }
    }
    ...
    private void openDrawer() {
        ...
        if (mOnDrawerOpenListener != null) {
            mOnDrawerOpenListener.onCusKeyboardOpened(mOpenCode);
        }
    }
    ...
    private class DrawerToggler implements OnClickListener {
        ...
        public void onClick(View v) {
            Log.d("VtKeyboard: ", " DrawerToggler ");
